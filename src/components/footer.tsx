...
export default function Footer(){
    return(
        ...
        <div className="w-full  sm:h-full lg:h-[350px] bg-neutral-900 flex justify-center items-center">
             <div className="sm:pl-[5%] md:pl-[10%] lg:pl-0 w-full gap-y-9 pt-3 sm:pb-6  flex sm:flex-col lg:flex-row justify-evenly text-white">
                   ...
                   <div className=" w-[200px]  ">
                    ...
                    <ul>
                      <li className="pt-1 cursor-pointer">B-382 DHA Phase1, Karachi,  KH 7200, Pakistan.</li>
                      <li className="pt-1 cursor-pointer">exclusive@gmail.com</li>
                      <li className="pt-1 cursor-pointer">+92-306-2401305</li>
                    </ul>
                   </div>
                   <div className=" w-[200px] ">
      ...
      <li>
        <Link href="https://youtu.be/d303R0kl5P4"  target="_blank" rel="noopener noreferrer">
          <FontAwesomeIcon icon={faYoutube} className=" text-3xl mr-2  transition duration-200 ease-out hover:scale-105 hover:ease-in" />
        </Link>
      </li>

      <li>
        <Link href="https://www.linkedin.com/in/saira-rizvi-3981aa295/" target="_blank" rel="noopener noreferrer" >
      ...
      <li>
        ...
        <p className="text-white text-center text-sm pb-4"><FontAwesomeIcon icon={faCopyright}className="text-lg mr-3  " ></FontAwesomeIcon>Copyright S.Rizvi 2022. All right reserved</p>
